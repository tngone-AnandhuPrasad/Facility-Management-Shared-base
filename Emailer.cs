...
namespace TNG.Shared.Lib.Communications.Email
{
    ...
    public class Emailer : IEmailer
    {
        ...
        public bool SendMailSendGrid(TNGEmail email)
        {
            ...
            mailMsg.From = new MailAddress("anandhuprasad0716@gmail.com", null);
            ...
            {
                System.Net.NetworkCredential credentials = new System.Net.NetworkCredential(this.eMailSettings.senderEmailId, this.eMailSettings.Password);
